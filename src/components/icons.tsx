...
export function Sparkle({ className }: { className?: string }) {
  return (
    <svg className={cn(iconBase, "w-4 h-4", className)} viewBox="0 0 20 20" fill="currentColor">
      <path d="M7.5 2a.5.5 0 01.5.5v1.58a6.5 6.5 0 017.92 7.92h1.58a.5.5 0 010 1H16.2a6.507 6.507 0 01-4.72 4.72v1.78a.5.5 0 01-1 0v-1.78A6.507 6.507 0 015.8 13H4a.5.5 0 010-1h1.58A6.5 6.5 0 017.5 4.08V2.5a.5.5 0 01.5-.5zM10 6a4 4 0 100 8 4 4 0 000-8z" />
    </svg>
  );
}

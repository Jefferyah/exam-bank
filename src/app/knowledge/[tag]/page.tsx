...
export default function KnowledgeEntryPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* Editor mode toggle + Prev/Next nav + AI tools */}
      <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl px-3 py-2 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-2">
          {/* Mode toggles */}
          <div className="flex items-center gap-1 bg-gray-50 dark:bg-gray-750 rounded-lg p-0.5 shrink-0">
            {([
          ...
          {navTags.length > 1 && currentIndex >= 0 && (
            <div className="flex items-center gap-1 min-w-0 order-last sm:order-none w-full sm:w-auto justify-center sm:justify-start">
              <button
                onClick={() => prevTag && router.push(`/knowledge/${encodeURIComponent(prevTag)}`)}
                disabled={!prevTag}
                className={`flex items-center gap-1 px-1.5 py-1 rounded-md text-xs transition-colors min-w-0 ${
                  prevTag
                ...
                title={prevTag || undefined}
              >
                <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                </svg>
                <span className="max-w-[80px] sm:max-w-[120px] truncate">{prevTag || "無"}</span>
              </button>
              <span className="text-[10px] text-gray-400 dark:text-gray-500 tabular-nums shrink-0 px-1">
              ...
              <button
                ...
                title={nextTag || undefined}
              >
                <span className="max-w-[80px] sm:max-w-[120px] truncate">{nextTag || "無"}</span>
                <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              return (
                <>
                  ...
                  <a href={urls.chatgpt} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center px-2 sm:px-2.5 py-1 bg-gray-50 dark:bg-gray-700 hover:bg-[#10a37f] text-gray-400 dark:text-gray-500 hover:text-white border border-gray-100 dark:border-gray-600 hover:border-transparent rounded-full text-[11px] font-medium transition-all">
                    ChatGPT
                  </a>
                  <a href={urls.claude} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center px-2 sm:px-2.5 py-1 bg-gray-50 dark:bg-gray-700 hover:bg-[#d97706] text-gray-400 dark:text-gray-500 hover:text-white border border-gray-100 dark:border-gray-600 hover:border-transparent rounded-full text-[11px] font-medium transition-all">
                    Claude
                  </a>
                  <a href={urls.gemini} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center px-2 sm:px-2.5 py-1 bg-gray-50 dark:bg-gray-700 hover:bg-[#4285f4] text-gray-400 dark:text-gray-500 hover:text-white border border-gray-100 dark:border-gray-600 hover:border-transparent rounded-full text-[11px] font-medium transition-all">
                    Gemini
                  </a>
                </>
              );
